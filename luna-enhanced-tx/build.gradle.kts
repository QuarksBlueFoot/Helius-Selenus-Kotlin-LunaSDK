...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            artifactId = "luna-enhanced-tx"
            version = project.version.toString()
            
            pom {
                name.set("LunaSDK Enhanced Transactions")
                description.set("Enhanced Transactions module for LunaSDK - Transaction parsing and enrichment")
